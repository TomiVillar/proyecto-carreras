...
frame_datos = LabelFrame(ventana, text="Ingrese sus datos:", bg="lightgrey", font=('Calibri', 20), borderwidth=5)
...
#etiquetas 
label_apellido = Label(frame_datos, text="Apellido: ", bg="lightgrey", fg="black", font=('Calibri', 15))
label_apellido.grid(row=2, column=0, pady=10, ipadx=100)

label_nombre = Label(frame_datos, text="Nombre: ", bg="lightgrey", fg="black", font=('Calibri', 15))
label_nombre.grid(row=3, column=0, pady=10, ipadx=100)

label_dni = Label(frame_datos, text="DNI: ", bg="lightgrey", fg="black", font=('Calibri', 15))
label_dni.grid(row=4, column=0, pady=10, ipadx=100,)

label_telefono = Label(frame_datos, text="Teléfono: ", bg="lightgrey", fg="black", font=('Calibri', 15))
label_telefono.grid(row=5, column=0, pady=10, ipadx=100)

label_domicilio = Label(frame_datos, text="Domicilio: ", bg="lightgrey", fg="black", font=('Calibri', 15))
label_domicilio.grid(row=6, column=0, pady=10, ipadx=100)

label_ciudad = Label(frame_datos, text="Ciudad: ", bg="lightgrey", fg="black", font=('Calibri', 15))
label_ciudad.grid(row=7, column=0, pady=10, ipadx=100)

label_correo = Label(frame_datos, text="Correo: ", bg="lightgrey", fg="black", font=('Calibri', 15))
label_correo.grid(row=8, column=0, pady=10, ipadx=100)

label_instagram = Label(frame_datos, text="Instagram: ", bg="lightgrey", fg="black", font=('Calibri', 15))
